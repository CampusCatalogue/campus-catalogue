    ...
    <div style={{overflowY:"hidden"}} >
      <div className="topmost" style={{height: "40vw"}}>
        <div className="horzsp1">
          <img style={{width:"7vw",height:"7vw"}} src={hamburger} alt="" />
          <div className="searchbox">
          <img className="searchicon" src={search} alt="" />
          <input className="inpstyle" type="text" placeholder="what/where you want to eat?" />
          </div>
          <div style={{borderRadius:"100%",height:"4vh",width:"10vw"}} className="temp" ></div>
        </div>
