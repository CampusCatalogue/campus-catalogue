...
function Page6() {
  ...
  return (
    <>
        <div className={styles.top}><FaArrowLeft/><span className={styles.topSpan}>Bill Total: Rs.{bill}</span></div>
        <div className={styles.div1}>Hey your order will get ready in  50 mins, we will notify you.</div>
        <div className={styles.notifs}><span>Notification settings </span>
        ...
        { Check? 
            ...
            <span className={styles.on} onClick ={()=>{setCheck(false)}}>On</span>:<span className={styles.on} onClick ={()=>{setCheck(true)}}>Off</span>
        }   
        </span>
        </div>
        ...
        <div className={styles.card}>
            ...
            <div className={styles.card1}>
                ...
                <div className={styles.right1}><FaAngleRight/></div>
            </div>
        </div>
        <div className={styles.card}>
            ...
            <div className={styles.card1}>
                ...
                <div className={styles.right2}><FaAngleRight/></div>
            </div>
        </div>
        <div className={styles.card}>
            ...
            <div className={styles.card1}>
                ...
                <div className={styles.right3}><FaAngleRight/></div>
            </div>
        </div>
